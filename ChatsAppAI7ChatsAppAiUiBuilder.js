...
var 7ChatsAppAiUiBuilder = (function() {

    console.log("Built ---- 7ChatsAppAiUiBuilder Object.");

    function 7ChatsAppAiUiBuilder(controller) {

        this.controller = controller;

    };

    7ChatsAppAiUiBuilder.prototype.testMethod = function() {

        console.log("Run ---- 7ChatsAppAiUiBuilder.");

        console.log(this.controller.people);

    };

    7ChatsAppAiUiBuilder.prototype.buildUi = function() {
